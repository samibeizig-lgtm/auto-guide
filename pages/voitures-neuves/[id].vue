<template>
  <div v-if="car" class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Retour -->
    <NuxtLink to="/voitures-neuves" class="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-700 mb-6 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
      ...
      <div class="relative bg-gray-50 rounded-2xl overflow-hidden aspect-[4/3]">
        ...
        <!-- Badges dynamiques -->
        <div v-if="car.badges && car.badges.length" class="absolute top-3 right-3 flex flex-col gap-1.5 items-end">
          <span
            v-for="badge in car.badges"
            :key="badge"
    ...
    <div v-else-if="car.features && car.features.length" class="card p-6 mb-8">
    ...
    <div v-if="(car.pros && car.pros.length) || (car.cons && car.cons.length)" class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
    ...
    <div>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <NuxtLink v-for="s in similarCars" :key="s._id" :to="`/voitures-neuves/${s._id}`"
  ...
  <div v-else class="text-center py-20">
    ...
    <NuxtLink to="/voitures-neuves" class="btn-primary mt-4 inline-block">Voitures neuves</NuxtLink>
  </div>
</template>
