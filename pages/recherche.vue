...
const budgetMin = ref<number | null>(route.query.budgetMin ? Number(route.query.budgetMin) : null)
const budgetMax = ref<number | null>(route.query.budgetMax ? Number(route.query.budgetMax) : null)
