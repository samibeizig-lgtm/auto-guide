      ...
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden md:flex items-center gap-1">
          <NuxtLink
            ...
            :key="link.to"
            :to="link.to"
            class="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-orange-600 hover:bg-orange-50 transition-all duration-200"
      ...
      <Transition name="dropdown">
        <div v-if="menuOpen" class="md:hidden border-t border-gray-100 py-3 space-y-1">
          <NuxtLink
            ...
            :key="link.to"
            :to="link.to"
            class="block px-3 py-2.5 text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg font-medium transition-colors"
            active-class="text-orange-600 bg-orange-50"
